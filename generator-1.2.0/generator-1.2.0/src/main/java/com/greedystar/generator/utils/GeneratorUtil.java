...
public class GeneratorUtil {
    ...
    public static String generateEntityProperties(String parentClassName, List<ColumnInfo> infos, String foreignKey) {
        ...
        if (!infos.get(0).getColumnName().equals(foreignKey)) {
            sb.append("    ").append("private List<").append(parentClassName).append("> ").append(StringUtil.firstToLowerCase(parentClassName)).append("s; \n");
            return sb.toString();
        } else {
...
//        sb.append("    ").append("private ").append(parentClassName).append(" ").append(StringUtil.firstToLowerCase(parentClassName)).append("; \n");
    ...
    public static String generateEntityMethods(String parentClassName, List<ColumnInfo> infos, String foreignKey) {
        ...
        if (!infos.get(0).getColumnName().equals(foreignKey)) {
            sb.append("    ").append("public void set").append(parentClassName).append("s (List<").append(parentClassName).append("> ").append(StringUtil.firstToLowerCase(parentClassName)).append("s) {this.").append(StringUtil.firstToLowerCase(parentClassName)).append("s = ").append(StringUtil.firstToLowerCase(parentClassName)).append("s;} \n");
            sb.append("    ").append("public List<").append(parentClassName).append("> get").append(parentClassName).append("s(){ return this.").append(StringUtil.firstToLowerCase(parentClassName)).append("s;} \n");
            return sb.toString();
        } else {
            sb.append("    ").append("public void set").append(parentClassName).append("s (").append(parentClassName).append(" ").append(StringUtil.firstToLowerCase(parentClassName)).append(") {this.").append(StringUtil.firstToLowerCase(parentClassName)).append(" = ").append(StringUtil.firstToLowerCase(parentClassName)).append(";} \n");
...
//                sb.append(tableName).append(".").append(infos.get(i).getColumnName()).append(" AS ").append("\"").append(infos.get(i).getPropertyName()).append("\",\n");
                sb.append(tableName).append(".").append(infos.get(i).getColumnName()).append(",\n");
            }
        }
...
//            sb.append("        ").append(parentTableName).append(".").append(info.getColumnName()).append(" AS ").append("\"").append(parentEntityName).append(".").append(info.getPropertyName()).append("\",\n");
            sb.append("        ").append(parentTableName).append(".").append(info.getColumnName()).append(",\n");
        }
        return sb.toString().substring(0, sb.toString().length() - 2);
    }
    ...
    public static String generateMapperResultMap(List<ColumnInfo> infos,String foreignKey) {
        ...
        for (ColumnInfo info : infos) {
            if (!info.getPropertyName().equals(foreignKey)){
...
//        for (ColumnInfo info : parentInfos) {
//            if (info.isPrimaryKey()) {
//                sb.append("            ").append("<id column=\"").append(info.getPropertyName()).append("\" property=\"").append(StringUtil.firstToLowerCase(parentClassName)).append("s").append(".").append(info.getPropertyName()).append("\"/> \n");
//            } else {
//                sb.append("            ").append("<result column=\"").append(info.getPropertyName()).append("\" property=\"").append(StringUtil.firstToLowerCase(parentClassName)).append("s").append(".").append(info.getPropertyName()).append("\"/> \n");
//            }
//        }
        for (ColumnInfo info : parentInfos) {
            if (info.isPrimaryKey()) {
                sb.append("            ").append("<id column=\"").append(info.getPropertyName()).append("\" property=\"").append(info.getPropertyName()).append("\"/> \n");
            } else {
                sb.append("            ").append("<result column=\"").append(info.getPropertyName()).append("\" property=\"").append(info.getPropertyName()).append("\"/> \n");
            }
        }
...
//        sb.append("LEFT JOIN ").append(parentTableName).append(" on ").append(parentTableName).append(".").append(parentPrimaryKey).append(" = ").append(tableName).append(".").append(foreignKey);
        sb.append("LEFT JOIN ").append(parentTableName).append(" on ").append(parentTableName).append(".").append(foreignKey).append(" = ").append(tableName).append(".").append(parentPrimaryKey);
        return sb.toString();
    }
